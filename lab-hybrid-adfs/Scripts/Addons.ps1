...
    #well-known appid for Powershell Azure
	$result = $AuthContext.AcquireTokenAsync($Resource,
	    "1950a258-227b-4e31-a9cf-717495945fc2",
	    [Uri]"urn:ietf:wg:oauth:2.0:oob",
	    [Microsoft.IdentityModel.Clients.ActiveDirectory.PromptBehavior]::0)
...
#        $Headers = Get-AuthHeader -Resource "https://portal.azure.com/" -TenantId $ctx.Tenant.TenantId
